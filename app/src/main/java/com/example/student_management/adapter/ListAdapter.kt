...
internal constructor(val context: Context, val noteDB: Student_Database)
  ...
  fun setNote(notes: List<Student_Entity>) {
    ...
    class ItemViewHolder(private val view: View) : RecyclerView.ViewHolder(view) {
        ...
        val textView2: TextView = view.findViewById(R.id.rs_address)
        val textView3: TextView = view.findViewById(R.id.rs_phone)
    ...
    override fun onBindViewHolder(holder: ItemViewHolder, position: Int) {
        ...
        holder.textView2.text = context.getString(R.string.address,currentNote.address.toString())
        holder.textView3.text = context.getString(R.string.phone,currentNote.phone.toString())
